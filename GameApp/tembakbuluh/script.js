...
"use strict";
    ...
    function drawBoard() {
        ...
        ctx.moveTo(board.x,board.y-40);
        ctx.quadraticCurveTo(board.x-10,board.y,board.x,board.y+40);
        //ctx.lineTo(10,6);
    ...
    Arrow.prototype.drawArrow = function() {
        if(this.vis) {
            ...
            try{
                                ...
                                document.getElementById("title").innerHTML = "SKOR KAMU<br>"+totalScore;
