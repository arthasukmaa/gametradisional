        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title fw-semibold mb-4">EDIT DATA KUIS</h5>
                </div>
                <div class="card-body">
                    <form action="{{ url('admin/kuis/editAct', $list->id) }}" method="POST" enctype="multipart/form-data"
                        novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="level" id="" class="form-control @error('level') is-invalid @enderror">
                                        ...
                                        @for ($i = 1; $i < 11; $i++)
                                        <option value="{{ $i }}" @if ($list->level == $i) selected @endif>{{ $i }}</option>
                                        @endfor
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="a" value="{{ $list->a }}" placeholder="Pilihan A ..." class="form-control @error('a') is-invalid @enderror"
                                        autocomplete="off">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="b" value="{{ $list->b }}" placeholder="Pilihan B ..." class="form-control @error('b') is-invalid @enderror"
                                        autocomplete="off">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="c" value="{{ $list->c }}" placeholder="Pilihan C ..." class="form-control @error('c') is-invalid @enderror"
                                        autocomplete="off">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="d" value="{{ $list->d }}" placeholder="Pilihan D ..." class="form-control @error('d') is-invalid @enderror"
                                        autocomplete="off">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="jawaban" value="{{ $list->jawaban }}" placeholder="Jawaban ..." class="form-control @error('jawaban') is-invalid @enderror"
                                        autocomplete="off">
