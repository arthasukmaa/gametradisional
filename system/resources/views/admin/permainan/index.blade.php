        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="card-title fw-semibold ">DATA PERMAINAN</h5>
                    <a href="{{ url('admin/permainan/tambah') }}" class="btn btn-success">Tambah</a>
                </div>
                <div class="card-body">
                    <table class="table" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th><center>Nama Permainan</center></th>
                                <th><center>Asal Daerah</center></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><center>{{ $item->asal_daerah }}</center></td>
                               
                                <td>
                                    <center>
                                        <div class="btn-group">
                                            <a href="{{ url('admin/permainan/detail', $item->id) }}" class="btn btn-warning">Detail</a>
                                            <a href="{{ url('admin/permainan/edit', $item->id) }}" class="btn btn-primary">Edit</a>
                            ...
                            <div class="modal fade" id="hapus{{ $item->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="{{ url('admin/permainan/hapus', $item->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-content">
                                            <div class="modal-header d-flex flex-column">
                                                ...
                                                <h1 class="modal-title fs-5 text-center mb-3" id="exampleModalLabel">HAPUS PERMAIANAN</h1>
