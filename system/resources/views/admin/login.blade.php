...
<head>
    ...
    <title>GAME</title>
    <link rel="shortcut icon" type="{{ url('public') }}/assets/assets/image/png"
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="#" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="{{ url('public') }}/assets/assets/images/logos/dark-logo.png"
                                        width="250" height="40" alt="">
                                </a>
                                <p class="text-center">Silahkan login menggunakan akun anda</p>
